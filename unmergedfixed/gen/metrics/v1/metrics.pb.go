...
// source: unmergedfixed/proto/metrics/v1/metrics.proto
...
import (
	...
	fmt "fmt"
	v11 "github.com/bogdandrutu/metrics-proto/unmergedfixed/gen/common/v1"
	v1 "github.com/bogdandrutu/metrics-proto/unmergedfixed/gen/resource/v1"
...
func (AggregationTemporality) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{0}
}
...
func (*InstrumentationLibraryMetrics) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{1}
}
...
type Metric struct {
	...
	// https://github.com/open-telemetry/unmergedfixed-specification/issues/731.
...
func (*Metric) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{2}
}
...
type IntGauge struct {
	DataPoints []Int64DataPoint `protobuf:"bytes,1,rep,name=data_points,json=dataPoints,proto3" json:"data_points"`
}
...
func (*IntGauge) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{3}
}
...
func (m *IntGauge) GetDataPoints() []Int64DataPoint {
	if m != nil {
		return m.DataPoints
	}
	return nil
...
type DoubleGauge struct {
	DataPoints []DoubleDataPoint `protobuf:"bytes,1,rep,name=data_points,json=dataPoints,proto3" json:"data_points"`
}
...
func (*DoubleGauge) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{4}
}
...
type IntSum struct {
	...
	AggregationTemporality AggregationTemporality `protobuf:"varint,2,opt,name=aggregation_temporality,json=aggregationTemporality,proto3,enum=unmergedfixed.proto.metrics.v1.AggregationTemporality" json:"aggregation_temporality,omitempty"`
...
func (*IntSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{5}
}
...
func (m *IntSum) GetDataPoints() []Int64DataPoint {
	if m != nil {
		return m.DataPoints
	}
	return nil
...
func (*DoubleSum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{6}
}
...
type IntHistogram struct {
	DataPoints []IntHistogramDataPoint `protobuf:"bytes,1,rep,name=data_points,json=dataPoints,proto3" json:"data_points"`
	// aggregation_temporality describes if the aggregator reports delta changes
	// since last report time, or cumulative changes since a fixed start time.
	AggregationTemporality AggregationTemporality `protobuf:"varint,3,opt,name=aggregation_temporality,json=aggregationTemporality,proto3,enum=unmergedfixed.proto.metrics.v1.AggregationTemporality" json:"aggregation_temporality,omitempty"`
}
...
func (*IntHistogram) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{7}
}
...
type DoubleHistogram struct {
	DataPoints []DoubleHistogramDataPoint `protobuf:"bytes,1,rep,name=data_points,json=dataPoints,proto3" json:"data_points"`
	// aggregation_temporality describes if the aggregator reports delta changes
	// since last report time, or cumulative changes since a fixed start time.
	AggregationTemporality AggregationTemporality `protobuf:"varint,3,opt,name=aggregation_temporality,json=aggregationTemporality,proto3,enum=unmergedfixed.proto.metrics.v1.AggregationTemporality" json:"aggregation_temporality,omitempty"`
}
...
func (*DoubleHistogram) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{8}
}
...
func (*Int64DataPoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{9}
}
...
func (m *Int64DataPoint) GetExemplars() []IntExemplar {
	if m != nil {
		return m.Exemplars
	}
	return nil
...
func (*DoubleDataPoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{10}
}
...
type IntHistogramDataPoint struct {
	...
	Sum uint64 `protobuf:"fixed64,5,opt,name=sum,proto3" json:"sum,omitempty"`
...
func (*IntHistogramDataPoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{11}
}
...
func (m *IntHistogramDataPoint) GetSum() uint64 {
	if m != nil {
		return m.Sum
	}
	return 0
...
func (*DoubleHistogramDataPoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{12}
}
...
func (*IntExemplar) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{13}
}
...
func (m *IntExemplar) GetDroppedLabels() []v11.StringKeyValue {
	if m != nil {
...
func (*DoubleExemplar) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab2e6cccfcc97f10, []int{14}
}
...
func (m *DoubleExemplar) GetDroppedLabels() []v11.StringKeyValue {
	if m != nil {
		return m.DroppedLabels
	}
	return nil
...
func init() {
	proto.RegisterEnum("unmergedfixed.proto.metrics.v1.AggregationTemporality", AggregationTemporality_name, AggregationTemporality_value)
	proto.RegisterType((*ResourceMetrics)(nil), "unmergedfixed.proto.metrics.v1.ResourceMetrics")
	proto.RegisterType((*InstrumentationLibraryMetrics)(nil), "unmergedfixed.proto.metrics.v1.InstrumentationLibraryMetrics")
	proto.RegisterType((*Metric)(nil), "unmergedfixed.proto.metrics.v1.Metric")
	proto.RegisterType((*IntGauge)(nil), "unmergedfixed.proto.metrics.v1.IntGauge")
	proto.RegisterType((*DoubleGauge)(nil), "unmergedfixed.proto.metrics.v1.DoubleGauge")
	proto.RegisterType((*IntSum)(nil), "unmergedfixed.proto.metrics.v1.IntSum")
	proto.RegisterType((*DoubleSum)(nil), "unmergedfixed.proto.metrics.v1.DoubleSum")
	proto.RegisterType((*IntHistogram)(nil), "unmergedfixed.proto.metrics.v1.IntHistogram")
	proto.RegisterType((*DoubleHistogram)(nil), "unmergedfixed.proto.metrics.v1.DoubleHistogram")
	proto.RegisterType((*Int64DataPoint)(nil), "unmergedfixed.proto.metrics.v1.Int64DataPoint")
	proto.RegisterType((*DoubleDataPoint)(nil), "unmergedfixed.proto.metrics.v1.DoubleDataPoint")
	proto.RegisterType((*IntHistogramDataPoint)(nil), "unmergedfixed.proto.metrics.v1.IntHistogramDataPoint")
	proto.RegisterType((*DoubleHistogramDataPoint)(nil), "unmergedfixed.proto.metrics.v1.DoubleHistogramDataPoint")
	proto.RegisterType((*IntExemplar)(nil), "unmergedfixed.proto.metrics.v1.IntExemplar")
	proto.RegisterType((*DoubleExemplar)(nil), "unmergedfixed.proto.metrics.v1.DoubleExemplar")
}

func init() {
	proto.RegisterFile("unmergedfixed/proto/metrics/v1/metrics.proto", fileDescriptor_ab2e6cccfcc97f10)
}

var fileDescriptor_ab2e6cccfcc97f10 = []byte{
	// 1112 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *IntGauge) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DataPoints = append(m.DataPoints, Int64DataPoint{})
...
func (m *IntHistogramDataPoint) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Sum = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
		case 6:
			if wireType == 1 {
				var v uint64
